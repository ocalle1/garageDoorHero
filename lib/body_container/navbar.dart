...
import 'package:my_website/widgets/ai_assistant/ai_floating_button.dart';
import 'package:my_website/widgets/ai_assistant/ai_chat_window.dart';
                ...
                child: Padding(
                  ...
                  child: Center(
                    child: HeroIntroChecks(
                      text:
                          heroIntroduction['descriptionHighlights']
                              ?.toString() ??
                          '',
                    ),
                  ),
